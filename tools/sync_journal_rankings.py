...
from journal_ranking_format import RANK_ORDER, format_publication_tags, normalized_publication_tags, parse_publication_tags
from researchos_card_metadata import known, metadata_heading_pattern, parse_metadata, yaml_scalar
from researchos_outputs import CORPUS_ZOTERO_LIBRARY_DB
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--researchos-root", default=str(Path(__file__).resolve().parent.parent))
