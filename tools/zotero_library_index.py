...
from tools.zotero_local_api import file_url_to_path, year_from_date
...
def command_ocr_check(args: argparse.Namespace) -> int:
    ...
    if not ok:
        print("NOTE: install Python OCR packages with tools\\build_local_python_env.ps1 and use tools\\ensure_ocr_needed.py for Tesseract setup.")
