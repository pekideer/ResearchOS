...
| 任务 | 默认入口 | 详细规则 |
|---|---|---|
| 从父文档读取条目或检索上下文 | `python tools\zotero\build_zotero_library_context_packet.py --item-key ITEMKEY --include-text` | `WORKFLOWS.md` 工作流 1、`RUNBOOKS/zotero-library-parent-documents.md` |
...
- `tools/zotero/zotero_ai_governance.py`：Zotero 文献库治理语料包和只读计划主入口；研究方向、标签和文献集语义由当前 ChatGPT/Codex agent 判断，代码只校验结构化结果。
