...
研究方向、研究方法和研究对象由当前 ChatGPT/Codex agent 基于可回溯语料判断；显式 taxonomy 只约束命名和范围，不由代码做关键词自动分类。期刊级别必须来自可信来源。
...
- `consider_collection_assignment`：agent 基于条目语料提出研究方向候选，但当前 collection 未体现该方向。
