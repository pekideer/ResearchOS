...
5. 判断是否需要先读取上下文：当前课题、继续上次、研究进展先读 `AGENTS.local-research.md`、`.researchos/active_ideas.md` 或项目 manifest；Obsidian、双链、读书卡人读入口先读 `RUNBOOKS/obsidian-zotero-codex-governance.md`；Zotero 读写先读父文档规则和写入策略。
...
- “最后汇报里告诉我我在哪、下一步做什么”：串联 `report-context-navigator`。
